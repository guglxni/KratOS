...
; FAT16 header starts here
; check "design of the FAT file system" on wikipedia
OEMIdentifier           db 'kratos ' 
...
; we need to read 256 words at a time
    ...
    rep insw
    pop ecx
    loop .next_sector ;loops back and decrements ecx
